...
public static class EnemyAPI
{
    ...
    public static event Action<EnemyAgent> OnPostEnemyDead { add => EnemyAPI_Impl.OnPostEnemyDead += value; remove => EnemyAPI_Impl.OnPostEnemyDead -= value; }
    ...
    public static event Action<EnemyAgent> OnEnemyDespawnd { add => EnemyAPI_Impl.OnEnemyDespawnd += value; remove => EnemyAPI_Impl.OnEnemyDespawnd -= value; }
}